...
@section('content')
                    ...
                    <form action = "{{route('sensoreCRUD.store')}}" method = "post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" list="tipo" name="tipo" autocomplete="off" placeholder="Seleziona uno dei tipi disponibili oppure inserisci un nuovotipo...">
